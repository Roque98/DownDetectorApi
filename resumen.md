...
## Objetivo
Proporcionar monitoreo automatizado en tiempo real de la disponibilidad y estado de servicios críticos de telecomunicaciones, permitiendo la detección temprana de incidentes y toma de decisiones proactivas basadas en reportes de usuarios a nivel global.
...
- **🚨 Sistema de Alertas Inteligente:** clasifica automáticamente el estado de cada servicio en cuatro niveles (Normal, Atención, Alerta, Emergencia) basándose en el volumen de reportes comparado con la línea base histórica.
...
### Tablas
- **Downdetector_Services:** Catálogo de servicios monitoreados con configuración de habilitación/deshabilitación
- **Downdetector_Reports:** Registro histórico de todos los reportes con valores actuales, líneas base y clasificación de estado

### Stored Procedures
- **usp_InsertReport:** Proceso de inserción de reportes con clasificación automática de estado según umbrales
- **usp_GetServiceStatus:** Consulta de estado actual de servicios
- **usp_GetHistoricalData:** Extracción de datos históricos para análisis y reportes
